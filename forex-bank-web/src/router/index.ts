...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'payment/templates', name: 'PaymentTemplateManager', component: () => import('@/views/payment/PaymentTemplateManager.vue'), meta: { title: '场景模板管理', icon: 'file-protect' } },
      ...
      { path: 'risk/sampling-rules', name: 'SamplingRuleConfig', component: () => import('@/views/risk/SamplingRuleConfig.vue'), meta: { title: '便利化抽查规则', icon: 'audit' } },
      ...
      { path: 'clearing/cips', name: 'CipsManagement', component: () => import('@/views/clearing/CipsManagement.vue'), meta: { title: 'CIPS管理', icon: 'global' } },
