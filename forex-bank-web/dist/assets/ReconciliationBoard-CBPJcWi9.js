import{I as Z}from"./InboxOutlined-DVH87KVj.js";import{i as j,v as q,f as g,b as I,h as t,N as n,w as r,y as o,u,G as Q,g as s,d as k,B as N,F as b,e as h,x as ee,a as i,_ as te}from"./index-CwOSX8XF.js";const ne={class:"reconciliation-board"},ae={class:"ant-upload-drag-icon"},le={key:1,style:{color:"#8c8c8c"}},oe=j({__name:"ReconciliationBoard",setup(se){const c=r([]),F=r(!1),B=[{title:"状态",dataIndex:"status",key:"status"},{title:"外部参考号",dataIndex:"externalRef",key:"externalRef"},{title:"内部交易号",dataIndex:"internalRef",key:"internalRef"},{title:"金额",dataIndex:"amount",key:"amount"},{title:"差异原因",dataIndex:"reason",key:"reason"},{title:"操作",key:"operation",width:160}],C=r([{id:"1",status:"MATCHED",externalRef:"CFX20260601001",internalRef:"FX20240001",amount:"USD 100,000",reason:"-"},{id:"2",status:"MATCHED",externalRef:"CFX20260601002",internalRef:"FX20240002",amount:"EUR 50,000",reason:"-"},{id:"3",status:"UNMATCHED",externalRef:"CFX20260601003",internalRef:"-",amount:"GBP 75,000",reason:"无匹配内部交易"},{id:"4",status:"UNMATCHED",externalRef:"-",internalRef:"FX20240005",amount:"JPY 10,000,000",reason:"无匹配CFETS确认"},{id:"5",status:"UNMATCHED",externalRef:"CFX20260601006",internalRef:"FX20240008",amount:"USD 200,000",reason:"金额差异超阈值(>0.01)"}]),X=q({current:1,pageSize:10,total:C.value.length}),v=r("MT300"),_=r(""),d=r(!1),y=r(null),m=r(void 0),D=r([{tradeNo:"FX20240001",currencyPair:"USD/CNY",amount:"100,000"},{tradeNo:"FX20240002",currencyPair:"EUR/CNY",amount:"50,000"},{tradeNo:"FX20240005",currencyPair:"JPY/CNY",amount:"10,000,000"},{tradeNo:"FX20240008",currencyPair:"USD/CNY",amount:"199,999.80"}]),U=l=>(l.type==="text/xml"||l.type==="text/csv"||l.name.endsWith(".xml")||l.name.endsWith(".csv")||i.error("只支持 .xml 和 .csv 格式文件"),!1);function E(l){X.current=l.current,X.pageSize=l.pageSize}function S(){F.value=!0,setTimeout(()=>{F.value=!1,i.success("CFETS数据导入成功"),c.value=[]},1500)}function H(l){y.value=l,m.value=void 0,d.value=!0}function w(l){C.value=C.value.filter(e=>e.id!==l.id),i.success(`已忽略 ${l.externalRef||l.internalRef}`)}function P(){if(!m.value||!y.value){i.warning("请选择内部交易");return}const l=y.value;l.status="MATCHED",l.internalRef=m.value,l.reason="手动匹配",d.value=!1,i.success("手动匹配成功")}function K(){const l={MT300:`{1:F01YOURBANKHKAXFXXXX0000000000}
